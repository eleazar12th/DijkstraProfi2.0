...
export const TURN_EDGES_RED_TEXT = "Теперь рассматриваем все, " +
    "ещё не обработанные (серые и голубые) вершины u, " +
    "в которые можно попасть из v.";
export const UPDATE_DISTANCE_TEXT = "Для каждой u пытаемся " +
    "улучшить значение distance(start, u). " +
    "Знаем, что в u можно попасть из v, а v уже обработана. " +
    "Пусть длина ребра из v в u равна len. Тогда наилучшее " +
...
export const SELECT_GREEN_NODE_TEXT = "Из голубых вершин " +
    "(то есть из тех, про которые уже что-то знаем), выбираем вершину v " +
    "с минимальным расстоянием от начальной и помечаем как обработанную " +
    "(красим в зелёный цвет). Минимальное расстояние до этой вершины найдено.";
